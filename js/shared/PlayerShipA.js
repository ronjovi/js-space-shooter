 ...
 */
 class PlayerShipA extends Phaser.Physics.Arcade.Sprite {
    constructor(scene, x, y) {
      super(scene, x, y, "player-ship-a"); // load player ship asset
    ...
    initPlayer(scene) {
      ...
      this.scene.anims.create({
        key: "player-ship-a-idle",
        frames: this.anims.generateFrameNumbers("player-ship-a"),
        frameRate: 20,
        repeat: -1,
      });
