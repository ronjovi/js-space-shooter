 ...
 */
 class PlayerShipC extends Phaser.Physics.Arcade.Sprite {
    constructor(scene, x, y) {
      super(scene, x, y, "player-ship-c"); // load player ship asset
    ...
    initPlayer(scene) {
      ...
      this.scene.anims.create({
        key: "player-ship-c-idle",
        frames: this.anims.generateFrameNumbers("player-ship-c"),
        frameRate: 20,
        repeat: -1,
      });
